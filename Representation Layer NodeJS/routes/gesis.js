	...
	var xml; //list of recommended articles in XML
	
		
	// handling gesis route
	...
	// rendering the recommended articles is views/gesis
	// response is list of articles in XML
	
exports.gesis= function(req, response){
